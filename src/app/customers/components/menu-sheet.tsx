      ...
      <nav className='divide-y divide-gray-200'>
        <div className='flex justify-center items-center'>
          ...
          <div className='px-6 py-4'>
            <h2 className='text-primary text-lg font-semibold mb-2'>MENU</h2>
          </div>

          {/* Categories Section */}
          <div className='px-6 py-4'>
            <h2 className='text-bkack text-lg font-semibold mb-2'>
              CATEGORIES
            </h2>
          </div>
        </div>
        ...
        <div className='px-6 py-8'>
          <h3 className='text-primary text-lg mb-4'>Follow us</h3>
          <div className='flex gap-4'>
            <Link
              href='#'
              className='p-3 rounded-full bg-[#ffeae4] text-primary hover:bg-primary hover:text-white transition-colors'
            >
              <svg
                className='w-5 h-5'
                fill='currentColor'
    ...
    <li>
      <Link
        ...
        className={`block px-6 py-4 transition-colors ${
          active ? 'bg-[#ffeae4]' : 'text-[#370e06] hover:bg-[#ffeae4]'
        }`}
      >
        {name}
      </Link>
